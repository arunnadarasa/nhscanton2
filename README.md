...
All funding allocation, approval, and reconciliation processes are enforced by Daml smart contracts, providing an immutable and privacy-preserving audit trail from government budget allocation to NHS expenditure.
